<template>
    <br>
    <router-link to="/" >
<img  src="https://cdn-icons-png.flaticon.com/512/93/93634.png?w=360" style="width: 8%;" alt="" title="retour" onMouseOver="document.all.texte.innerText='Retour !'" value="Ok !">
    </router-link>
    <img src="https://d3i4yxtzktqr9n.cloudfront.net/web-eats-v2/ee037401cb5d31b23cf780808ee4ec1f.svg" style="padding-left: 8px;"
        alt="uber_eats_logo">
    <br>
 <br>
 <br>
 <u>
 <h5 class="text-center ">Présentation du restaurant <span class="text-danger"> {{ restaurant.name }}</span></h5> </u>
 <center>
    
   <div class="restaurant--image "> 
    <br> <br>   <img :src="restaurant.logo" class=" shadow-lg text-center img-fluid rounded" alt="" style="width: 90%;">
   <br><br> <br> </div> </center>
    <br><br>
    <div class=" " style="padding: 30px;"> Découvrez {{restaurant.name}} notre restaurant à {{restaurant.note}} étoiles offrant un temps de livraison entre {{restaurant.drive_time}}. <br>
